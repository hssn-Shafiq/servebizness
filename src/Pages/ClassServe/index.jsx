...
export const ClassofServe = () => {
  ...
  <div className="cards text-center  container-gap">
    <h3>Our Unbeatable Writing Services</h3>
    <p>
    ...
    <div className="row px-5 g-0 mt-4">
      ...
      <div className="col-lg-3 overflow-hidden">
        <div
          className="card rounded-4 mt-2"
          style={{ width: "17rem", height: 280 }}
        >
  ...
  {/* Offer */}
  <div className="offer-section container-gap">
  ...
  <div className="container ">
    <div className="row">
      ...
      <div className="col-lg-6">
        <h3>Why Choose Our Writing Services?</h3>
        <p>
  ...
  <div className="container-counter container-gap">
    <div className="row text-center py-5 text-light" style={{ width: "100%" }}>
      <div className="col-lg-3">
        <h1>20K+</h1>
